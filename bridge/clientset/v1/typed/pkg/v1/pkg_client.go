...
import (
	...
	"istio.io/pilot/bridge/clientset/v1/scheme"
...
// PkgV1Client is used to interact with features provided by the pkg group.
type PkgV1Client struct {
	restClient rest.Interface
}

func (c *PkgV1Client) Meshs() MeshInterface {
	return newMeshs(c)
}
